...
const BREAK_DUR = 50000; // 50000 milliseconds break (50s)
...
wmt_instrhelper.break_block =
    "<div class='WMT_instr'>" +
    "<p class='continue_next'>We will have a short <b>" + BREAK_DUR/1000 + " seconds</b> break before we continue. Please wait.</p>" +
    "</div>";
